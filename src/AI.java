...
public class AI {
    ...
    public static void checkForCriticalPoint(){
        ...
        System.out.println("instead of blocking, finish the game. Field: "+ nextMove);
    ...
    private static void findGoodMove() {
        ...
        else if(XIndexes.contains("3")&&XIndexes.contains("6")&&Field.defaultField.charAt(71)=='9'){nextMove=9;}
        ...
        if (nextMove!=1000){
            Field.defaultField = Field.defaultField.replace(Integer.toString(nextMove),"O")   ;
            //System.out.println(Field.defaultField);
            System.out.println("Blocked at field: "+nextMove);
            Game.checkForThreeInARow();
            Game.askForMove();
        }
